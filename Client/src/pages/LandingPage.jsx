...
console.log('Icons loaded:', { MonitorHeartIcon, HealthAndSafetyIcon, LocalHospitalIcon });
        ...
        <div className="min-h-screen bg-white">
            ...
            <section className="py-20 bg-gray-50">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-16">
                        <h2 className="text-4xl font-bold text-gray-900 mb-4">Why Choose CardioHealth?</h2>
                ...
                <div className="container mx-auto px-4">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                        <div className="p-6">
                            ...
                            <p className="text-xl text-blue-100">Accuracy Rate</p>
                        </div>
                        <div className="p-6">
                        ...
                        <div className="p-6">
                            ...
                            <p className="text-xl text-blue-100">Monitoring</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-20 bg-gray-50">
                <div className="container mx-auto px-4 text-center">
                    <h2 className="text-4xl font-bold text-gray-900 mb-4">Ready to Take Control of Your Heart Health?</h2>
            ...
            <footer className="bg-gray-900 text-white py-12">
                <div className="container mx-auto px-4">
                    <div className="flex items-center justify-center mb-8">
                        <FavoriteIcon sx={{ fontSize: 30, color: '#2563eb' }} className="mr-2" />
                        <span className="text-2xl font-bold">CardioHealth</span>
                    </div>
